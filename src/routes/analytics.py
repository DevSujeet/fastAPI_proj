...
async def get_projects_count_by_state() -> List[ProjectsCountByLocationResponse]:
    """
...
async def get_all_projects_by_location(location:LocationRequest) -> List[ProjectsByLocationResponse]:
    """
...
async def get_project_status_overview(location:str) -> ProjectStatusOverViewResponse:
    """
...
async def get_location_status_overview(location:str) -> ProjectStatusOverViewResponse:
    """
